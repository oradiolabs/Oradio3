...
document.addEventListener('DOMContentLoaded', () =>
{
	...
	{
		const dropdown = container.querySelector('.scrollbox');
		options.forEach(option =>
		{
			const div = createRow(option);
			div.classList.add('playlist-row');			// for delegation
			div.dataset.playlist = network.playlist;	// store playlist
